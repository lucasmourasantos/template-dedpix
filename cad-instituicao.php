            ...
            <form class="needs-validation" action="server/server.php" method="POST" novalidate>
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <h5>Nome: </h5>
                        <input type="text" class="form-control" id="firstName" name="nome" placeholder="Nome da Instituição" value="" required>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <h5>Endereço: </h5>
                        <input type="text" class="form-control" id="firstName" name="endereco" placeholder="Endereço da Instituição" value="" required>
                        <div class="invalid-feedback">
                            Valid first name is required.
                        </div>
                    </div>
