                ...
                <form class="needs-validation" action="server/server.php" method="POST" novalidate>
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <h5>Disciplina: </h5>
                            <input type="text" class="form-control" id="firstName" name="descricao" placeholder="Entre com a disciplina" value="" required>
                    ...
                    <div class="col-md-3 mb-3">
                        <button class="btn btn-primary btn-lg btn-block" type="submit" name="disciplina">Confirmar</button>
                    </div>
                </div>
                </form>
            </div>
